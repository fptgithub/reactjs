...
function Danhmuc(){
    ...
    const [danhmuc,setDanhmuc] = useState({id:'',tensp:'',soluong:''})
    const [danhmucs,setDanhmucs] = useState([])
    const [danhmucs1,setDanhmucs1] = useState([])
    useEffect(() =>{
      axios.get('https://603c418cf4333a0017b674fb.mockapi.io/oder?p='+Page+'&l=5')
        .then(res => {
    ...
    const Them = ()=>{
      axios.post('https://603c418cf4333a0017b674fb.mockapi.io/oder?p='+Page+'&l=5',danhmuc)
        .then(res => {
        const persons = res.data;
    ...
    const Sua = ()=>{
      axios.put('https://603c418cf4333a0017b674fb.mockapi.io/oder/'+danhmuc.id,danhmuc)
        .then(res => {
        const persons = res.data;
    ...
    const Xoa = (x)=>{
      axios.delete('https://603c418cf4333a0017b674fb.mockapi.io/oder/'+x.id)
        .then(res => {
